  ...
  return (
    <main className="min-h-screen text-white p-10 relative overflow-hidden">
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-start ">
        ...
        <div className="mt-12 bg-gray-900 p-6 rounded-2xl max-w-3xl transition duration-300 hover:scale-105 hover:shadow-[0_0_40px_rgba(34,211,238,0.3)] border border-cyan-500/20">
